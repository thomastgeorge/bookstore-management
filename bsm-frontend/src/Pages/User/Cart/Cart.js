...
// Media queries as inline styles
const mediaQueries = {
  largeScreen: {
  ...
  cardRegistration2: {
    '@media (min-width: 992px)': {
      '.card-registration-2 .bg-grey': styles.cardRegistration2BgGrey,
    },
    '@media (max-width: 991px)': {
      '.card-registration-2 .bg-grey': styles.cardRegistration2BgGreyMobile,
    },
  },
};
                  ...
                  <MDBCol lg="4" style={styles.bgGrey}>
                    <div className="p-5">
                      ...
                      <div className="mb-4 pb-2">
                        <select className="select p-2 rounded" style={styles.select}>
